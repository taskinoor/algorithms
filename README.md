...
Implementation of some common data structures and algorithms using C++ (`-std=c++11`). The main purpose of this is to learn, and that's why every implementation contains reference section. However, most of the implementations are generic, so they can be used in other works too.
